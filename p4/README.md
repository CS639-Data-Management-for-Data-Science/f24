...
1. Inside your notebook, use the appropriate `bash` command to download ```data.zip``` if your starting repo doesn't have it. Use this URL to download: https://github.com/CS639-Data-Management-for-DataScience/f24/raw/442903c8bbd229bb56132ec7df373d90849714f0/p4/data.zip
